...
As the increasing exchange value of Kusama/Polkadot, more and more institutes especially some organization or companies may occupy more and more important positions. They may hold more and more validators in the whole less than 1000 validators because only a few free people could afford the cost of maintaining standalone valiator. Thus degree of decentralization of KSM/DOT network may be a problem. 

Therefore, it is important to increase the proportion of nodes held by individual users It is the key means of decentralization. Holding too many nodes will not only cause the problem of decentralization, but also reduce the overall participation of the system, such as voting, participating in proposals, such as the update speed of the new version, etc., as well as the large-scale offline of nodes caused by some graph publishing situations, which will be adverse to the development of the system. 1kV plan (Web3 specially launched the 1kV plan, that is, through the support of Web3, some individual users only need to provide a small amount of pledge, that is, they can have a node.) It is a key project to reduce the degree of system centralization and keep the system decentralized enough and sufficient participants.
